...
public class JedisUtil {
    ...
    private JedisUtil(String host, int port, String password, int maxTotal, int maxIdle, long maxWaitMillis, boolean testOnBorrow) {
        if (pool == null) {
            JedisPoolConfig jedisPoolConfig = new JedisPoolConfig();

            /*
            // https://blog.csdn.net/lisheng19870305/article/details/84613505
            ...
            jedisPoolConfig.setTestOnBorrow(testOnBorrow);// 在获取连接的时候检查有效性, 默认false
